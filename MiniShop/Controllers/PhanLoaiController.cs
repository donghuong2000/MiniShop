    ...
    public class PhanLoaiController : Controller
    {
        ...
        public IActionResult Upsert(string ma_phan_loai,string ten_phan_loai)  
        {
            if(ModelState.IsValid)
            {
                 ...
                 var result = _unitOfWork.SP_Call.Excute(SD.Phan_Loai.INSERT_PHAN_LOAI, parameter);
                if(result.success)
                {
        ...
        {
            var result = _unitOfWork.SP_Call.Excute(SD.Phan_Loai.GET_ALL_PHAN_LOAI);
            if(result.success)
            {
        ...
        public IActionResult get(string id)
        {
            ...
            var result =_unitOfWork.SP_Call.Excute(SD.Phan_Loai.GET_PHAN_LOAI, parameter);
            if(result.success)
            {
                return Content(result.message, "application/json");
            }    
        ...
        public IActionResult Update(string oldId,string newId,string newValue)
        {
            ...
            var result = _unitOfWork.SP_Call.Excute(SD.Phan_Loai.UPDATE_PHAN_LOAI,parameter);
            if(result.success)
            {
        ...
        public IActionResult Delete(string id)
        {
            var parameter = new DynamicParameters();
            parameter.Add("@MA_PHAN_LOAI", id);
            var result = _unitOfWork.SP_Call.Excute(SD.Phan_Loai.DELETE_PHAN_LOAI, parameter);
            if (result.success)
            {
